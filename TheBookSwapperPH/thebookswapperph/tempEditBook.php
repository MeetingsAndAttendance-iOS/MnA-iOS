<?php
	...
	include 'backend/getBookNames.php';
	    ...
	    <form action="backend/editBook.php" method="post">
	            <div class="panel panel-primary">
	              <div class="panel-heading">
	                <h3 class="panel-title">Book Name & Author</h3>
	              </div>
	              ...
	              <div class="panel-body">
	                <select name="book">
						<?php
							...
							{
								?>
								<option value="<?php echo $book->bookID; ?>"><?php echo $book->bookName; ?> by <?php echo $book->bookAuthor; ?></option>
...
<!--				
	    ...
	    <div style="float: right; text-align:right; width:50%">
				<input type='hidden' name= 'libraryID'  value=" <?php echo $_SESSION['libraryID'] ?> ">
