<?php
	...
	include 'backend/getMyBooks.php';
	    		...
	    		<div class = "col-md-12">
					...
					<select name="mybook">
						<?php
							...
							{
								if($_SESSION['id'] == $mybook->userID){
								?>
								
								<option value="<?php echo $mybook->bookID; ?>"><?php echo $mybook->bookName; ?> by <?php echo $mybook->bookAuthor; ?></option>
