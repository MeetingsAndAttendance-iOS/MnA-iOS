    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="index.php">TheBookSwapperPH</a>
									...
									<div class = "thumbnail">
										<div class = "caption">
											...
											<form name = "viewBookForm" action="tempViewBook.php" method="post">
												<input type="hidden" name="libraryID" value="<?php echo $temp->libraryID; ?>">
												<div class = "pull-left">Book:
												<button type="submit" class="btn btn-link btn-md"><?php echo $temp->bookName; ?></button></div>
											</form>

											<p><br> Trading For: <br>
										
											<?php
											foreach($other_library as $other_temp)
											{
												if(($other_temp->bookWantID == 1) && ($other_temp->libraryID == $temp->libraryID)){
												?>
												<b>Anything
												<?php	
												}
												else if(($other_temp->libraryID == $temp->libraryID)){
												?>
												<b><?php echo $other_temp->bookName; ?>
												<?php
												}
											} 
											?> 
