...
function draw_calendar()
{
	...
	/* table headings */
	$headings = array('Book Name','Book Author','Trading For','Book Author');
	...
	foreach($trade as $temp)
	{
		...
		$calendar .= "</td>";
		foreach($othertrade as $othertemp){
			$calendar .= "<td class='calendar-day'>";
			$calendar .= "<h5> $othertemp->bookName</h5>";
			$calendar .= "</td>";

			$calendar .= "<td class='calendar-day'>";
			$calendar .= "<h5> $othertemp->bookAuthor </h5>";
			$calendar .= "</td>";
		}
		$calendar .= "</tr>";
